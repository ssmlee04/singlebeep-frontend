...
class Landing extends React.Component<void, Props, void> {
  ...
  render() {
    ...
    let { message1 = 'Singlebeep', message2 = 'Find someone who shares a common interest with you!' } = this.props;
    let style = {};
    if (src) {
            ...
            <div className='row'>
              <div className='col-lg-6 col-md-6 col-lg-offset-6 col-md-offset-6 '>
                <div className='intro-message'>
                  ...
                  <br/>
                  <br/>
                  <h2 style={{color: '#f8f8f8', fontFamily: 'Verdana'}}>{message1}</h2>
                  <h4 className='quotefont' style={{color: '#f8f8f8'}}>{message2}</h4>
